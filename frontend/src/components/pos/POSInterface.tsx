...
export default function POSInterface({ originModule }: POSInterfaceProps = {}) {
        ...
        },
        {
            ...
            action: () => {
                if (lastSale) {
                    ...
                    toast('🖨ï¸ Último recibo', { duration: 1000 });
                } else {
        ...
        },
        {
            ...
            action: () => {
                if (checkoutModalOpen) {
                    ...
                    clearCart();
                    toast('🗑ï¸ Carrinho limpo', { duration: 1500 });
                }
            },
    ...
    const handleSimulateScale = () => {
        ...
        setTimeout(() => {
            ...
            toast.success('Peso capturado da balança!', { icon: '⚖ï¸' });
        }, 1500);
    };
    ...
    const handleAddWeightedProduct = () => {
        ...
        toast.success(`${scaleProduct.name} adicionado (${weight}kg)`, { icon: '⚖ï¸' });
        setScaleModalOpen(false);
    ...
    return (
        <div className="flex-1 flex flex-col min-h-0">
            {/* Mobile tabs (Catalogo/Carrinho) — sticky, only < md */}
            <div className="md:hidden sticky top-14 z-20 px-1 py-2 bg-slate-100 dark:bg-dark-950 border-b border-slate-200 dark:border-dark-800 mb-2">
