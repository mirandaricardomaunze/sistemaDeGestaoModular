...
export const CacheKeys = {
    // Dashboard
    dashboardMetrics: (companyId: string, warehouseId?: string) => `dashboard:metrics:${companyId}:${warehouseId || 'all'}`,
    dashboardSales: (companyId: string, period: string, warehouseId?: string) => `dashboard:sales:${companyId}:${period}:${warehouseId || 'all'}`,
    dashboardTopProducts: (companyId: string, limit: number, period: number, warehouseId?: string) =>
