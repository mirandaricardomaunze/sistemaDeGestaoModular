...
export default function Footer() {
    ...
    return (
        <footer className="hidden lg:block py-2.5 px-4 lg:px-6 bg-white dark:bg-dark-800 border-t border-gray-200 dark:border-dark-700 transition-colors duration-200">
