        ...
        <div className="space-y-6 animate-fade-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <Card variant="glass" className="p-4 border-l-4 border-l-orange-500 flex items-center gap-4">
                    <div className="p-3 rounded-xl bg-orange-50 dark:bg-orange-900/20 text-orange-600">
                        ...
                        <Card key={person.id} variant="glass" className="relative group overflow-hidden border-t-2 border-t-primary-500/30">
                            <div className="p-5 space-y-4">
                                <div className="flex items-start gap-4">
                                    <div className="w-12 h-12 rounded-2xl bg-indigo-100 dark:bg-indigo-900/30 flex items-center justify-center text-indigo-600 font-black text-lg">
                                ...
                                <div className="flex gap-2 pt-2">
                                    <Button
                                        ...
                                        size="sm"
                                        className="flex-1 rounded-xl font-black text-[10px] uppercase"
                                    ...
                                    <Button
                                        variant="outline"
                                        size="sm"
                                        className="flex-1 rounded-xl font-black text-[10px] uppercase border-orange-200 text-orange-600"
