...
export const canViewPage = (user: User | null | undefined, path: string): boolean => {
    ...
    const pathPermissionMap: Record<string, Permission> = {
        ...
        '/commercial/dashboard': 'view_dashboard',
        '/commercial/insights': 'view_reports',
        '/commercial/reports': 'view_reports',
        '/commercial/margins': 'view_reports',
        '/commercial/history': 'view_pos',
        '/commercial/stock': 'view_inventory',
        '/commercial/shifts': 'view_pos',
        '/commercial/audit': 'view_audit',
        ...
        '/commercial/categories': 'view_inventory',
        '/commercial/suppliers': 'view_inventory',
        '/commercial/purchase-orders': 'manage_inventory',
        '/commercial/supplier-invoices': 'view_financial',
        '/commercial/quotes': 'view_pos',
        '/commercial/accounts-receivable': 'view_financial',
        '/commercial/finance': 'view_financial',
        '/commercial/returns': 'view_financial',
        '/commercial/pending-voids': 'view_pos',
        '/commercial/employees': 'view_employees',
        '/commercial/settings': 'manage_settings',
        '/alerts': 'view_dashboard',
        '/reports': 'view_reports',
        '/audit': 'view_audit',
        '/approvals': 'view_dashboard',
