...
export function PharmacyShiftDetailsModal({ isOpen, session, onClose, onPrint }: PharmacyShiftDetailsModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative z-10 w-full max-w-2xl bg-white dark:bg-dark-800 rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
                {/* Header */}
                ...
                <div className="overflow-y-auto p-6 space-y-6">
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                        <div className="p-3 bg-gray-50 dark:bg-dark-900 rounded-2xl border border-gray-100 dark:border-dark-700">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="bg-gray-50 dark:bg-dark-900/50 rounded-3xl p-5 space-y-3 border border-gray-100 dark:border-dark-700">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="bg-gray-100/50 dark:bg-dark-900 rounded-3xl p-5 space-y-3 border border-gray-200 dark:border-dark-700">
                                <div className="flex justify-between items-center mb-1">
                                    <span className="text-xs text-gray-500 font-medium italic">Informado no Fecho</span>
                                    <span className="text-base font-black text-teal-600 dark:text-teal-400">{formatCurrency(session.closingBalance || 0)}</span>
                                </div>
                                
                                {session.closedAt && (
                                    <div className={`p-4 rounded-2xl flex items-center justify-between ${Math.abs(diff) < 0.01 ? 'bg-green-50 dark:bg-green-900/10' : 'bg-red-50 dark:bg-red-900/10'}`}>
                                ...
                                <div className="pt-2 border-t border-gray-200 dark:border-dark-700 space-y-1.5">
                                    ...
                                    <div className="flex justify-between items-center pt-2 border-t border-gray-100 dark:border-dark-800">
                                        ...
                                        <span className="text-sm font-black text-teal-600 dark:text-teal-400">{formatCurrency(session.totalSales)}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    {/* Operations */}
                    <div className="bg-gray-50 dark:bg-dark-900/40 p-5 rounded-3xl space-y-3">
                ...
                <div className="px-6 py-4 bg-gray-50 dark:bg-dark-900/50 border-t border-gray-100 dark:border-dark-700 flex gap-3">
                    ...
                    <Button 
                        className="flex-1 rounded-2xl font-black uppercase text-[10px] tracking-widest h-12 flex items-center justify-center gap-2 shadow-xl shadow-teal-500/10 text-white bg-teal-600 hover:bg-teal-700 border-none"
                        onClick={onPrint}
                    >
