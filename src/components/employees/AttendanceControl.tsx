        ...
        <div className="space-y-6">
            ...
            {isLoading ? (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {[1, 2, 3].map(i => (
                        <div key={i} className="h-48 bg-gray-100 dark:bg-dark-800 animate-pulse rounded-lg" />
                    ))}
                </div>
            ) : filteredRoster.length === 0 ? (
                <EmptyState
                    title="Ãrea de Ponto Vazia"
                        ...
                        <Card key={emp.id} className="relative group overflow-hidden border-t-4 border-t-primary-500">
                            ...
                            <div className="flex flex-col h-full gap-4">
                                <div className="flex items-start gap-4">
                                    <div className="w-14 h-14 rounded-lg bg-primary-100 dark:bg-primary-900/30 flex items-center justify-center text-primary-600 dark:text-primary-400">
            ...
            <Modal
                ...
                title="Adicionar à Ãrea de Ponto"
                size="md"
            >
                <div className="space-y-6 pt-4">
                    ...
                    {addType === 'individual' ? (
                        <div className="space-y-3">
                            ...
                            <div className="max-h-60 overflow-y-auto border border-gray-200 dark:border-dark-700 rounded-lg divide-y divide-gray-100 dark:divide-dark-800">
                        ...
                        <div className="space-y-2">
                            ...
                            <select
                                className="w-full p-3 bg-white dark:bg-dark-800 border-2 border-gray-100 dark:border-dark-700 rounded-lg outline-none focus:border-primary-500 focus:ring-4 focus:ring-primary-500/10 transition-all font-medium"
