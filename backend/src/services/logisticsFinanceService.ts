...
export class LogisticsFinanceService {
    ...
    async getTransactions(companyId: string, query: ListQuery) {
        ...
        const where: Prisma.TransactionWhereInput = { companyId, module: 'logistics' };
    ...
    async updateTransaction(id: string, companyId: string, data: Partial<TransactionInput>) {
        ...
        const existing = await prisma.transaction.findFirst({
            where: { id, companyId, module: 'logistics' }
        });
...
export const logisticsFinanceService = new LogisticsFinanceService();
