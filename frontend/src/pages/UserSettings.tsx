...
const passwordSchema = z.object({
    ...
    newPassword: z.string()
        ...
        .regex(/[0-9]/, 'Nova senha deve conter pelo menos um dígito'),
...
export default function Settings() {
    ...
    const businessTypeOptions = [
        { value: 'retail', label: 'Comércio / Retalho', icon: HiOutlineShoppingBag, description: 'Loja de artigos diversos, vestuário, eletrónicos' },
        { value: 'pharmacy', label: 'Farmácia', icon: HiOutlineBeaker, description: 'Medicamentos, controle de lotes e validades' },
        { value: 'supermarket', label: 'Supermercado', icon: HiOutlineShoppingCart, description: 'Mercearia, balança e alto volume de vendas' },
        { value: 'bottlestore', label: 'Bottle Store', icon: HiOutlineSparkles, description: 'Garrafeira, bebidas e gestão de vasilhame' },
        { value: 'hotel', label: 'Hotel / Residencial', icon: HiOutlineBuildingOffice2, description: 'Hospedagem, gestão de quartos e reservas' },
        { value: 'logistics', label: 'Logística / Armazém', icon: HiOutlineTruck, description: 'Gestão de estoque multifocal e transferências' },
    ];
    ...
    return (
        <div className="space-y-6">
            ...
            {activeTab === 'profile' && (
                <div className="space-y-6">
                    {/* User Info Card */}
                    <Card padding="lg" className="bg-primary-50 dark:bg-primary-900/20 border border-primary-200 dark:border-primary-800">
                    ...
                    <Card padding="lg">
                        <div className="flex items-center gap-3 mb-6">
                            <div className="w-10 h-10 rounded-xl bg-amber-100 dark:bg-amber-500/15 border border-transparent dark:border-amber-500/20 flex items-center justify-center backdrop-blur-sm">
                                <HiOutlineLockClosed className="w-5 h-5 text-amber-600 dark:text-amber-300" />
                            </div>
                            <div>
                                ...
                                return (
                                    ...
                                    >
                                        <div className="flex flex-col h-full">
                                            <div className="mb-2 group-hover:scale-110 transition-transform text-primary-600 dark:text-primary-400">
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        {isLoadingStats ? (
                            ...
                            <>
                                <Card padding="lg" className="bg-white dark:bg-dark-900 border border-gray-100 dark:border-blue-500/20 shadow-sm overflow-hidden group">
                                    <div className="flex items-center justify-between">
                                        <div>
                                ...
                                <Card padding="lg" className="bg-white dark:bg-dark-900 border border-gray-100 dark:border-green-500/20 shadow-sm overflow-hidden group">
                                    <div className="flex items-center justify-between">
                                        <div>
                                        ...
                                        <div className="w-12 h-12 rounded-xl bg-green-100 dark:bg-green-500/15 border border-transparent dark:border-green-500/30 flex items-center justify-center backdrop-blur-sm group-hover:scale-110 transition-transform">
                                            <HiOutlineUsers className="w-6 h-6 text-green-600 dark:text-green-300" />
                                        </div>
                                    </div>
                                </Card>

                                <Card padding="lg" className="bg-white dark:bg-dark-900 border border-gray-100 dark:border-purple-500/20 shadow-sm overflow-hidden group">
                                    <div className="flex items-center justify-between">
                                        <div>
                                        ...
                                        <div className="w-12 h-12 rounded-xl bg-purple-100 dark:bg-purple-500/15 border border-transparent dark:border-purple-500/30 flex items-center justify-center backdrop-blur-sm group-hover:scale-110 transition-transform">
                                            <HiOutlineCheckCircle className="w-6 h-6 text-purple-600 dark:text-purple-300" />
                                        </div>
                                    </div>
                                </Card>

                                <Card padding="lg" className="bg-white dark:bg-dark-900 border border-gray-100 dark:border-amber-500/20 shadow-sm overflow-hidden group">
                                    <div className="flex items-center justify-between">
                                        <div>
                                        ...
                                        <div className="w-12 h-12 rounded-xl bg-amber-100 dark:bg-amber-500/15 border border-transparent dark:border-amber-500/30 flex items-center justify-center backdrop-blur-sm group-hover:scale-110 transition-transform">
                                            <HiOutlineCog className="w-6 h-6 text-amber-600 dark:text-amber-300" />
                                        </div>
                                    </div>
                                </Card>
                            </>
