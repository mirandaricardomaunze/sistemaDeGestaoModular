        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative z-10 w-full max-w-2xl bg-white dark:bg-dark-800 rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
                ...
                <div className="px-6 py-4 bg-gray-50 dark:bg-dark-900/50 border-t border-gray-100 dark:border-dark-700 flex gap-3">
                    ...
                    <Button 
                        className="flex-1 rounded-2xl font-black uppercase text-[10px] tracking-widest h-12 flex items-center justify-center gap-2 shadow-xl shadow-indigo-500/10"
                        onClick={onPrint}
                    >
