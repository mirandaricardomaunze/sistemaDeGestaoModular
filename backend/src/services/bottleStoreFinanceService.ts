...
export class BottleStoreFinanceService {
    ...
    async getTransactions(companyId: string, query: ListQuery) {
        ...
        const where: Prisma.TransactionWhereInput = { companyId, module: 'bottle_store' };
    ...
    async updateTransaction(id: string, companyId: string, data: Partial<TransactionInput>) {
        ...
        const existing = await prisma.transaction.findFirst({
            where: { id, companyId, module: 'bottle_store' }
        });
...
export const bottleStoreFinanceService = new BottleStoreFinanceService();
